...
date: 2025-06-05
image: "/images/build-an-ai-server-on-a-budget/IMG_3172.webp"
imageMeta: "/images/build-an-ai-server-on-a-budget/IMG_3172.webp"
...
_Why did I decide to invest in an on-prem, DIY server?_
...
- **Maker**: Nvidia was the obvious choice. Their hardware has wide industry adoption so the software (e.g. drivers, CUDA) ecosystem and community is mature.
  - _Nvidia vs AMD_: AMD GPUs with ROCm lets you peer deeper into the stack internals, but the supporting software and community for AI use cases is still nascent.
  - _Nvidia vs Apple_: Devices with Apple Silicon are more closed. They don't expose the mid- and low-level layers for optimization. Also, you're not going to find M-series chips in data centers so your technical learnings and implementation are limited to edge deployments.
- **Price**: Under $700.
  ...
  <tbody>
    <tr>
      ...
      <td className="p-3 border">
        <a
          href="https://www.amazon.com/MSI-Motherboard-Bluetooth-Desktop-Processors/dp/B0CB6XZ7RH/ref=sr_1_2"
          className="text-blue-600 hover:underline"
        >
          MSI B650 Gaming Plus WiFi Gaming Motherboard (AMD Ryzen 9000/8000/7000
          Series Processors, AM5, DDR5, PCIe 4.0, M.2, SATA 6Gb/s, USB 3.2 Gen
          2, HDMI/DP, Wi-Fi 6E, Bluetooth 5.3, 2.5Gbps LAN, ATX)
        </a>
      </td>
    ...
    <tr>
      ...
      <td className="p-3 border">
        <a
          href="https://www.amazon.com/AMD-7600-12-Thread-Unlocked-Processor/dp/B0BMQJWBDM/ref=sr_1_2"
          className="text-blue-600 hover:underline"
        >
    ...
    <tr>
      ...
      <td className="p-3 border">
        <a
          href="https://www.amazon.com/G-Skill-288-Pin-CL36-36-36-96-Channel-F5-6000J3636F16GX2-FX5/dp/B0BFGB2D2Z/ref=sr_1_7_sspa"
          className="text-blue-600 hover:underline"
        >
          G.SKILL Flare X5 Series (AMD Expo & Intel XMP 3.0) DDR5 RAM 32GB
          (2x16GB) 6000MT/s CL36-36-36-96 1.35V Desktop Computer Memory UDIMM -
          Matte Black
        </a>
      </td>
    ...
    <tr>
      ...
      <td className="p-3 border">
        <a
          href="https://www.amazon.com/Western-Digital-SN5000-Internal-Solid/dp/B0D7MLHCQ7/ref=sr_1_14"
          className="text-blue-600 hover:underline"
        >
          Western Digital 1TB WD Blue SN5000 NVMe Internal Solid State Drive SSD
          - PCIe Gen 4.0, M.2 2280, Up to 5,150 MB/s
        </a>
      </td>
    ...
    <tr>
      ...
      <td className="p-3 border">
        <a
          href="https://www.amazon.com/GIGABYTE-750W-PSU-Certified-GP-UD750GM/dp/B0DPNHR9H3/ref=sr_1_5"
          className="text-blue-600 hover:underline"
        >
          GIGABYTE 750W PSU - 80 Plus Gold Certified - Fully Modular Power
          Supply (GP-UD750GM-A)
        </a>
      </td>
      <td className="p-3 border">$90</td>
    ...
    <tr>
      ...
      <td className="p-3 border">
        <a
          href="https://www.amazon.com/CORSAIR-4000D-Modular-Airflow-Mid-Tower/dp/B0DPJ9K8WK/ref=sr_1_5"
          className="text-blue-600 hover:underline"
        >
          CORSAIR 4000D RS Frame Modular High Airflow Mid-Tower PC Case - 3X
          CORSAIR RS Fans - InfiniRail Fan Mounting System - Fits Multiple 360mm
          Radiators - Reverse Connector Motherboard Compatible - Black
        </a>
      </td>
...
![Server components](/images/build-an-ai-server-on-a-budget/IMG_3136.webp)
...
![Unboxed components](/images/build-an-ai-server-on-a-budget/IMG_3138.webp)
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3147.webp"
    alt="Motherboard - Top"
    width="300"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3148.webp"
    alt="Motherboard - Angle"
    width="300"
  />
</div>
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3149.webp"
    alt="CPU Chip"
    width="300"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3151.webp"
    alt="CPU Installed"
    width="300"
  />
</div>
...
![CPU Fan - Angled](/images/build-an-ai-server-on-a-budget/IMG_3153.webp)

Plugged the fan's power cord to the motherboard's `CPU_FAN1` connector.

![CPU_FAN1](/images/build-an-ai-server-on-a-budget/IMG_3152.webp)
...
![RAM DIMMs](/images/build-an-ai-server-on-a-budget/IMG_3154.webp)

#### Step 2.2.3: Install SSD

![SSD](/images/build-an-ai-server-on-a-budget/IMG_3155.webp)
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3156.webp"
    alt="Motherboard with cover plate removed"
    width="200"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3157.webp"
    alt="Motherboard with SSD inserted"
    width="200"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3158.webp"
    alt="Motherboard with cover plate reinstalled"
    width="200"
  />
</div>
...
![Case with panels and railing off](/images/build-an-ai-server-on-a-budget/IMG_3159.webp)

### Step 2.4: Install PSU

Placed the PSU at the bottom of the case.

![PSU](/images/build-an-ai-server-on-a-budget/IMG_3160.webp)
...
![I/O Shield](/images/build-an-ai-server-on-a-budget/IMG_3161.webp)

Then, I mounted the motherboard into the built-in tray in the case, screwing it into place.

![Motherboard Mounted](/images/build-an-ai-server-on-a-budget/IMG_3162.webp)

Made sure the I/O ports on the motherboard were aligned with the I/O shield.

![Motherboard with I/O ports aligned with I/O shield](/images/build-an-ai-server-on-a-budget/IMG_3163.webp)
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3141.webp"
    alt="Motherboard with cover plate removed"
    width="200"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3142.webp"
    alt="Motherboard with SSD inserted"
    width="200"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3145.webp"
    alt="Motherboard with cover plate reinstalled"
    width="200"
  />
</div>
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3166.webp"
    alt="GPU Installed - Case Flat"
    width="300"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3167.webp"
    alt="GPU Installed - Case Standing"
    width="300"
  />
</div>
...
![Anti-Sag Mount](/images/build-an-ai-server-on-a-budget/IMG_3168.webp)

I re-attached the side panel on the I/O side of the GPU, making sure the GPU ports were exposed.

![GPU Ports Exposed](/images/build-an-ai-server-on-a-budget/IMG_3169.webp)
...
![Front Panel LED Lights Power Connection](/images/build-an-ai-server-on-a-budget/IMG_3164.webp)
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3170.webp"
    alt="Power Cables"
    width="300"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3171.webp"
    alt="Top-Right Power Connectors"
    width="300"
  />
</div>
...
>
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3172.webp"
    alt="Running Server"
    width="300"
  />
  <img
    src="/images/build-an-ai-server-on-a-budget/IMG_3173.webp"
    alt="Monitor after Power On"
    width="300"
  />
</div>
...
![Case Panels Re-Attached](/images/build-an-ai-server-on-a-budget/IMG_3194.webp)
...
![WiFi Antenna](/images/build-an-ai-server-on-a-budget/IMG_3177.webp)
...
![Create Bootable Drive](/images/build-an-ai-server-on-a-budget/create_bootable_drive.png)
...
![BIOS Setup](/images/build-an-ai-server-on-a-budget/IMG_3178.webp)

### Step 3.4: Install OS

I chose "Try or Install Ubuntu Server" and pressed `Enter`. That initiated the OS installation, which took a few minutes.

![Ubuntu Installation](/images/build-an-ai-server-on-a-budget/IMG_3179.webp)
...
![Language Selection Screen](/images/build-an-ai-server-on-a-budget/IMG_3180.webp)

Then installation type.

![Installation Type Selection Screen](/images/build-an-ai-server-on-a-budget/IMG_3181.webp)

The network configuration. This is where I connected the server to my home WiFi network.

![Network Configuration](/images/build-an-ai-server-on-a-budget/IMG_3182.webp)

![Network Configuration - WiFi Settings](/images/build-an-ai-server-on-a-budget/IMG_3183.webp)

Took note of the **assigned IP address in my local network: `192.168.0.34`**

Left the proxy settings empty.

![Proxy Settings](/images/build-an-ai-server-on-a-budget/IMG_3184.webp)

Then came the Ubuntu archive mirror address. Left it as-is.

![Ubuntu Archive Mirror Selection](/images/build-an-ai-server-on-a-budget/IMG_3185.webp)
...
![Storage Configuration Screen 1](/images/build-an-ai-server-on-a-budget/IMG_3186.webp)

![Storage Configuration Screen 2](/images/build-an-ai-server-on-a-budget/IMG_3187.webp)

Profile configuration. This is where you setup your user profile with password. Also name the server (I named it, `scale-1`).

![Profile Configuration Screen](/images/build-an-ai-server-on-a-budget/IMG_3188.webp)

Installed OpenSSH server so I can access the server using a secure remote connection from my computer via SSH.

![OpenSSH Server Installation Screen](/images/build-an-ai-server-on-a-budget/IMG_3190.webp)

Didn't install any server snaps.

![Server Snaps Installation Screen](/images/build-an-ai-server-on-a-budget/IMG_3191.webp)

Installation complete!

![Installation Complete Screen](/images/build-an-ai-server-on-a-budget/IMG_3192.webp)
...
![First Terminal Session Screen](/images/build-an-ai-server-on-a-budget/IMG_3193.webp)
...
![SSH Tunnel](/images/build-an-ai-server-on-a-budget/first_ssh_tunnel.png)
...
![htop](/images/build-an-ai-server-on-a-budget/htop.png)
...
![nvidia-smi](/images/build-an-ai-server-on-a-budget/nvidia-smi.png)
...
![Stress Test and Sensor Monitoring](/images/build-an-ai-server-on-a-budget/stress_test.png)
